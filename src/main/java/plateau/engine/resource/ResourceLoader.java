...
import plateau.engine.PlateauEngine;
...
public class ResourceLoader {
    ...
    public static ByteBuffer[] getIcon(String file) throws IOException {
    ...
    private static int bindTexture(String file) {
        try {
            BufferedImage image = ImageIO.read(PlateauEngine.class.getResourceAsStream("../../" + file));
